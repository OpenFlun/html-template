# 变更日志
## [4.0.7] - 2026-04-28 20:13
### 修复:
- 通过增加 customize/hotReloadInjector.js 文件,并在account.js中引入该文件函数,修复了用户登录相关页修改后,没有实际刷新页面的问题;
### 优化:
- 将所有文件中的 ./static/... 改为 /static/...;
- 用户登录相关页全面适配深浅色模式,切换主题按钮,返回顶部按钮,以及这2个按钮的拖拽支持等;
- 改动后 .d.ts 文件的同步完善;
---
