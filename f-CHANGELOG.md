# 变更日志
## [4.0.3] - 2026-04-27 20:37
### 修复:
1. 修复了 /api/user 请求在没有启用登录时,场景处理不完善的问题;
2. 修复了 /static/styling.js 引用不同步,造成 account 全局标志失效的问题;
### 优化:
- 将 /api/user/:name 改为 /api/hi/:name;避免和登录场景 /api/user 造成混淆;
---
